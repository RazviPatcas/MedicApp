                ...
                <div class="footer-container footer-a" style="padding-right:10px;">
                    <div class="tbl">
                        ...
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell">
                                <p class="paragraph-medium paragraph-white">support@medicapp.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tbl">
                        <div class="tbl-row">
                            ...
                            <ul class="tbl-cell">
                                ...
                                <li><a href="forget_pass.php">Ai uitat parola </a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="footer-subscribe">
                        <form action="" method="post">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input">
                                ...
                                <label class="mdl-textfield__label" for="subscribe-email">Adresă de email</label>
                                <span class="mdl-textfield__error">Introdu o adresă de email</span>
                            </div>
                            <div class="footer-subscribe-button">
                                <button type="submit" id="subscribe-submit" name="subscribe" class="mdl-button mdl-js-button mdl-js-ripple-effect btn btn-success">Trimite</button>
                            </div>
                        </form>
                    </div>
