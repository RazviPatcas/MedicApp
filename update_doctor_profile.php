        ...
        <div class="row layer-wrapper text-center">
            <div class="col-md-8 form-full-container">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                    $sql = "SELECT * FROM doctors where id = {$_SESSION['doctor_id']}";
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input is-upgraded"
                                 data-upgraded=",MaterialTextfield">
                                <input class="mdl-textfield__input hasDatepicker" type="text" name="dob" value="<?php echo $doctor->age;?>"
                                       id="">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input is-upgraded"
                                 data-upgraded=",MaterialTextfield">
                                <input class="mdl-textfield__input" type="text" name="bloodgroup" value="A+"
                                       id="profile-bg">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input is-upgraded"
                                 data-upgraded=",MaterialTextfield">
                                <input class="mdl-textfield__input" type="text" value="<?php echo $doctor->hospital_id;?>" name="location"
                                       id="profile-location">
                ...
                if (isset($_POST['profilepassword'])){
                    ...
                    foreach ($doctors as $doctor) {
                        if ($doctor->password == $op && $np == $cp){
                            $sql = "UPDATE doctors SET `password`='$np' where id = $id";
                            $result = $pdo->prepare($sql);
                            $result->execute();
